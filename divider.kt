...
/*
* Kotlin code to find how many times a random number n can be divided by another number less than it
* Divisor should not be equal to 1; it creates and infinite count
*
* */
...
fun main(args: Array<String>) {
    ...
    while(temp>1 && divisor>1)           //divisor should not reduce the number n below 1
